 ...
 */
class Generator extends Doer_1.default {
    constructor(urlFetcher, folder, baseImage) {
...
`;
        ...
        const aptPackages = this.aptPackages(baseIdentifier);
...
`;
     ...
     */
    baseVersionName(baseIdentifier) {
