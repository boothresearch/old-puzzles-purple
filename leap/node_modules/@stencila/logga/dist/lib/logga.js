...
function emitLogData(info, tag, level) {
  ...
  } else if (level <= exports.LogLevel.error) {
...
function getLogger(tag) {
  return {
    error(message) {
      emitLogData(message, tag, exports.LogLevel.error);
    },

    warn(message) {
      emitLogData(message, tag, exports.LogLevel.warn);
    },

    info(message) {
      emitLogData(message, tag, exports.LogLevel.info);
    },

    debug(message) {
      emitLogData(message, tag, exports.LogLevel.debug);
    }
